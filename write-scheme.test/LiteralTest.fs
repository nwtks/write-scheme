...
let number () =
    ...
    "#b101@101" |> rep |> should startWith "1.4183"
...
let string () =
    ...
    "\"first line\\ \n  second line\""
    |> rep
    |> should equal "\"first linesecond line\""

    "\"escaped\\\"quote\"" |> rep |> should equal "\"escaped\\\"quote\""
